...
export class WidgetsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: WidgetsRequestBuilderGetRequestConfiguration | undefined) : Promise<Widget[] | undefined> {
        const requestInfo = this.toGetRequestInformation(
            requestConfiguration
        );
        return this.requestAdapter.sendCollectionAsync<Widget>(requestInfo, createWidgetFromDiscriminatorValue, undefined);
    };
    /**
     ...
     * @returns a Promise of Widget
     */
    public post(body: WidgetCreate | undefined, requestConfiguration?: WidgetsRequestBuilderPostRequestConfiguration | undefined) : Promise<Widget | undefined> {
