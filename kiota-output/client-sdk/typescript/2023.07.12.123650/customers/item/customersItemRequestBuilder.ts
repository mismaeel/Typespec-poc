...
export class CustomersItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: CustomersItemRequestBuilderDeleteRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public get(requestConfiguration?: CustomersItemRequestBuilderGetRequestConfiguration | undefined) : Promise<Customer | undefined> {
     ...
     * @returns a Promise of Customer
     */
    public patch(body: CustomerUpdate | undefined, requestConfiguration?: CustomersItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<Customer | undefined> {
