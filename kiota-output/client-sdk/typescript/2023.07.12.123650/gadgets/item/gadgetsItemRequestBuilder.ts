...
export class GadgetsItemRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public delete(requestConfiguration?: GadgetsItemRequestBuilderDeleteRequestConfiguration | undefined) : Promise<void> {
     ...
     */
    public get(requestConfiguration?: GadgetsItemRequestBuilderGetRequestConfiguration | undefined) : Promise<Gadget | undefined> {
        const requestInfo = this.toGetRequestInformation(
            requestConfiguration
        );
        return this.requestAdapter.sendAsync<Gadget>(requestInfo, createGadgetFromDiscriminatorValue, undefined);
    };
    /**
     ...
     * @returns a Promise of Gadget
     */
    public patch(body: GadgetUpdate | undefined, requestConfiguration?: GadgetsItemRequestBuilderPatchRequestConfiguration | undefined) : Promise<Gadget | undefined> {
     ...
     * @returns a Promise of Gadget
     */
    public put(body: GadgetCreateOrUpdate | undefined, requestConfiguration?: GadgetsItemRequestBuilderPutRequestConfiguration | undefined) : Promise<Gadget | undefined> {
        if(!body) throw new Error("body cannot be undefined");
