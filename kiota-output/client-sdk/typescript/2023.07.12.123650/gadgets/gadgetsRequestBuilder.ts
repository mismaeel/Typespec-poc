...
export class GadgetsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public get(requestConfiguration?: GadgetsRequestBuilderGetRequestConfiguration | undefined) : Promise<Gadget[] | undefined> {
        const requestInfo = this.toGetRequestInformation(
            requestConfiguration
        );
        return this.requestAdapter.sendCollectionAsync<Gadget>(requestInfo, createGadgetFromDiscriminatorValue, undefined);
    };
    /**
     * Get a list of resources
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
